...
public class DontForgetTheLyrics {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "After listening to a song segment, complete the rest of the line!");
		// 5. Use the playSound method to play your song.
		playSound("song.wav");
		// 6. Make a pop-up for the player to type their answer.
		String answer = JOptionPane.showInputDialog("When the pimps in the crib ma....... ");
		// 7. If they answered correctly, tell them that they were right.
		if(answer.equalsIgnoreCase("Drop it like its hot")){
